...
export const succesMsj =
  "La actividad solicitada, ha sido realizada exitosamente";
export const successTitle = "Acción realizada correctamente";
export const errorMsj =
  "No se ha realizado la actividad por lo cual le pedimos intentar nuevamente, en caso contrario contactar a soporte técnico para solucionar el problema";
